...
- pin_list:
  ...
  - {pin_num: '39', peripheral: SIUL2, signal: 'gpio, 31', pin_signal: PTA31, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
  - {pin_num: '42', peripheral: SIUL2, signal: 'gpio, 50', pin_signal: PTB18, direction: OUTPUT, pullSelect: pullUp, InitValue: state_1}
